...
#pay given to the salesperson and returns it
...
# the determine_comm_rate function accepts the amount of 
# sales as an argument and returns the applicable commission rate 
